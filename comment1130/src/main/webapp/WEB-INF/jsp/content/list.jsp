...
<body style="background: #e1e9eb;">
	<form action="${basePath}/ad/initList" id="mainForm" method="post">
				...
				<table class="tab1">
					<tbody>
						<tr>
							...
							<td><input id="title" name="title" value="" class="allInput" type="text" />
							</td>
							<td style="text-align: right;" width="150">
								<input class="tabSub" value="查询" onclick="#" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
								<input class="tabSub" value="添加" onclick="location.href='${basePath}/ad/addPage'" type="button" />
							</td>
						</tr>
					</tbody>
				</table>
