		...
		<div class="right">
			...
			<div class="rightCont">
				...
				<table class="tab1" width="100%">
					<tbody>
						<tr>
							...
							<td width="30%"><input id="title" value="学钢琴" name="title"
								class="allInput" style="width: 100%;" type="text" /></td>
								
							<td align="right" width="10%">链接地址<font color="red">*</font>：</td>
							<td width="30%"><input id="link" name="link"
								value="http://www.imooc.com/wap/index" class="allInput"
								style="width: 100%;" type="text" /></td>
						</tr>
						
						<tr>
							<td align="right" width="10%">上传图片<font color="red">*</font>：</td>
							<td width="30%"><input id="imgFile" name="imgFile"
								class="allInput" style="width: 100%;" type="file" />
							</td>
							
							
							<td align="right" width="10%">权重<font color="red">*</font>：</td>
							<td width="30%"><input id="weight" name="weight" class="allInput"
								style="width: 100%;" type="text" /></td>
						</tr>
				...
				<div style="text-align: center; margin-top: 30px;">
					<input id="save" class="tabSub" value="保     存" type="button" />&nbsp;&nbsp;&nbsp;&nbsp;
