		    ...
		    <div id="header">
		        <div class="iheader">
		            ...
		            <ul class="nav" id="mainMenuUl">
		            	...
		            	<li onclick="clickFirstMenu(this,'${basePath}/ad/initList')" class="on"><a><span>内容管理</span></a></li>
		            </ul>
		        </div>
		    </div>
		    <div id="container">
		                ...
		                <td class="leftTd" style="vertical-align:top" width="150">
		                    <div class="left">
		                        <div class="ileft" id="menuDiv">
		                        	<h3 onclick="clickFirstMenu(this,'${basePath}/ad/initList');"><a>广告管理</a></h3>
		                        	<%-- <h3 onclick="clickFirstMenu(this,'${basePath}/ad/initModify');"><a>维护页面</a></h3> --%>
		                        </div>
		                    </div>
		                </td>
		                <td width="7">
